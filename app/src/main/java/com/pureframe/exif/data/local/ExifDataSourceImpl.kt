...
class ExifDataSourceImpl(private val resolver: ContentResolver) : ExifDataSource {

    override suspend fun getMetadata(uri: Uri): ExifMetadata = withContext(Dispatchers.IO) {
